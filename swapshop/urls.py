...
urlpatterns = [
    ...
    url(r'^category/(?P<subpk>\d+)/list/$', views.SubCatListView.as_view(), name='subcat_list_view'),
    url(r'^category/(?P<subpk>\d+)/thumb/$', views.SubCatThumbView.as_view(), name='subcat_thumb_view'),
    url(r'^category/(?P<subpk>\d+)/gallery/$', views.SubCatGalleryView.as_view(), name='subcat_gallery_view'),
