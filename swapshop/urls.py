...
urlpatterns = [
    ...
    url('^api/register/$', SwapShopRegisterAPIView.as_view(), name='swapshop_register_api_view'),
    ...
    url(r'^api/main_categories/add/$', SwapShopCategoryCreateAPIView.as_view(), name='swapshop_category_create_view'),
